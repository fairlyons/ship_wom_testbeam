...
/*    if(track->GetTrackStatus() == fStopAndKill) {
	...
	if(posttouchable->GetCopyNumber(0) >= 0 && posttouchable->GetCopyNumber(0) < 5) sipm = 0;
        ...
        else if(posttouchable->GetCopyNumber(0) >= 40 && posttouchable->GetCopyNumber(0) < 45) sipm = 8;
        else if(posttouchable->GetCopyNumber(0) >= 45 && posttouchable->GetCopyNumber(0) < 50) sipm = 9;
        else if(posttouchable->GetCopyNumber(0) >= 50 && posttouchable->GetCopyNumber(0) < 55) sipm = 10;
        else if(posttouchable->GetCopyNumber(0) >= 55 && posttouchable->GetCopyNumber(0) < 60) sipm = 11;
        else if(posttouchable->GetCopyNumber(0) >= 60 && posttouchable->GetCopyNumber(0) < 65) sipm = 12;
        else if(posttouchable->GetCopyNumber(0) >= 65 && posttouchable->GetCopyNumber(0) < 70) sipm = 13;
        else if(posttouchable->GetCopyNumber(0) >= 70 && posttouchable->GetCopyNumber(0) < 75) sipm = 14;
        else if(posttouchable->GetCopyNumber(0) >= 75 && posttouchable->GetCopyNumber(0) < 80) sipm = 15;
