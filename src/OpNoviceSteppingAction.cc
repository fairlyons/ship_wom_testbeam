...
/*    if(track->GetTrackStatus() == fStopAndKill) {
    ...
    if(postphysvolname == "sipmSens") {
      if(sipm_detection(1.24e-3 / track->GetKineticEnergy())) {
		...
		// Top right
		if(posttouchable->GetCopyNumber(0) >= 2000 && posttouchable->GetCopyNumber(0) < 2005) sipm = 16;
		...
		// Bottom left
		if(posttouchable->GetCopyNumber(0) >= 3000 && posttouchable->GetCopyNumber(0) < 3005) sipm = 32;
		...
		// Bottom right
		if(posttouchable->GetCopyNumber(0) >= 4000 && posttouchable->GetCopyNumber(0) < 4005) sipm = 48;
