...
//    new G4LogicalBorderSurface( (std::string("WLSSurface_")+std::to_string(pos)).c_str(), WLS_tube2_phys_vect[pos], WOM_tube_phys_vect[pos], AirBoxSurface);
 ...
 11.7364909186509,12.943617756497,38.1908081955548,16.6488888058538,19.1187061362638,26.7334655790205,29.7746096076586,        35.7572000618953,36.8950525383479,38.834406796401,40.2088285102441,36.333977297541,31.4552729744343,31.7565672164803,
  ...
  for(int i=0; i<18; i++) photonEnergy8[i] = 1240./waveLength6[i]*eV;
   ...
   G4double specular_coating[59] = { 0.275981400966183,0.220335265700483,0.174939734299517,0.158831642512077,
   0.136866062801932,0.126615458937198,0.120757971014492,0.097328019323671,0.092934903381642,   0.114900483091787,0.1017211352657,0.107578623188406,0.109042995169082,0.109042995169082,0.103185507246377,
   0.094399275362319,0.095863647342995,0.097328019323671,0.044610628019324,
 0.085613043478261,0.076826811594203,0.062183091787439,0.076826811594203,0.053396859903381,0.049003743961353,
 0.051932487922705,0.047539371980676,0.054861231884058,0.060718719806763,
   0.060718719806763,0.063647463768116,0.066576207729469,0.060718719806763,0.059254347826087,0.060718719806763,
   0.053396859903381,0.062183091787439,0.062183091787439,0.065111835748792,
   0.059254347826087,0.059254347826087,0.059254347826087,0.059254347826087,0.060718719806763,0.063647463768116,
   0.063711607635545,0.109487793307116,0.264162594904879,0.256288310957396,
   0.224518495879269,0.164557880256238,0.116341911708279,0.065861697428529,0.035685477513136,0.030090217391304,
   0.039604841899681,0.04968164332469,0.040865808762931,0.02776263876456}; // specular reflection Patrick data ???
   ...
   MTP_BaSO->AddProperty("SPECULARLOBECONSTANT", photonEnergy8, specular_coating,59); // In order to have diffuse reclectivity (Lambertian), it is necessary define all the other three. The diffuse is 
   MTP_BaSO->AddProperty("SPECULARSPIKECONSTANT", photonEnergy9, other_coating,2); // 1-other three (in this case 1). 
