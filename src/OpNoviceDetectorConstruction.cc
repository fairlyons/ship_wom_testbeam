...
void OpNoviceDetectorConstruction::DefineMPTs()
{
  ...
  MPT_LAB_PPO->AddProperty("ABSLENGTH", photon_en_LAB_PPO_3, absLen_unpurified, 151)->SetSpline(true);
  ...
  for(unsigned int i = 0; i < sizeof(photonEnergy_Si)/sizeof(photonEnergy_Si[0]); i++) photonEnergy_Si[i] = 1240./waveLength_Si[i]*eV;
