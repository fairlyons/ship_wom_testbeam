...
void OpNoviceDetectorConstruction::DefineMPTs()
{
  ...
  MPT_LAB_PPO->AddProperty("FASTCOMPONENT", photon_en_LAB_PPO_2, scintilFast_LAB_PPO, 201, true, true);
  MPT_LAB_PPO->AddProperty("SLOWCOMPONENT", photon_en_LAB_PPO_2, scintilFast_LAB_PPO, 201, true, true);
